...
def get_job_spec(job_config, command, savedir_logs, workdir, role=None):
    ...
    # _job_config['role'] = 'eai.issam.role'
    # _job_config['name'] = 'eai.issam'
...
def get_jobs(api, **kwargs):
    ...
    return api.v1_role_job_get(role_id=kwargs['role_id'],
            limit=1000, 
            order='-created',
